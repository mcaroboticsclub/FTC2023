 ...
 */
@Autonomous
public class backBlueAuton extends LinearOpMode {
    ...
    private static final String TFOD_MODEL_FILE = "/sdcard/FIRST/tflitemodels/BluePropModel.tflite";
    ...
    private int findPropPos(){
        ...
        if (tfod.getRecognitions().size()==0) return 0;
